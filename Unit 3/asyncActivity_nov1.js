...
// You would use "let" for something that can change (let image). You would use Const for something that doesn't change, like a password.
...
// listening, work ethic, and stay awake